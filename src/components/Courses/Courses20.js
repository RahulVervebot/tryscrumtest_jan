...
const Courses20 = (props) => {
  ...
  const tablecourses = useStaticQuery(graphql`
    {
      allWpPost(
        filter: { acfcoursePage: { course20: { position: { eq: 1 } } } }
      ) {
        nodes {
          uri
          title
        ...
        <tr style={{ "box-shadow": "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" }}>
          <td>
            <b style={{ fontSize: "2.3vmin", fontWeight: "600" }}>
              {e.acfcoursePage.course20.time1}
              {" - "}
              {e.acfcoursePage.course20.date1}
            </b>
            <br />
            <b style={{ fontSize: "17px", color: "#2196f3" }}>
              {e.acfcoursePage.course20.trainer}
            </b>
          </td>
          ...
          <td>
            <b style={{ textDecoration: "underline" }}>
              ...
              {e.acfcoursePage.course20.location
                ? e.acfcoursePage.course20.location
                : "Not available"}
            </b>
            <br />
          ...
          {/* {e.acfcoursePage.course20.url} */}
            ...
            >
              <s>{e.acfcoursePage.course20.regularPrice}</s> {""}{" "}
              {e.acfcoursePage.course20.salePrice}
            </p>
            <Modal url={e.acfcoursePage.course20.url} />
          </td>
        </tr>
      ))}
    </>
