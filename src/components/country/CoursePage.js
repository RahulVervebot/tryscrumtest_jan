    ...
    >
          {ddata.allWpPost.nodes.map((tl) => (
            ...
            <Tab eventKey="tab1" title={  <div
                          className="tab-courses-font headnewstyle" style={{fontSize:"18px",fontWeight:"600" }}
...
<div class="wCard-quote__heading mb-3" style={{fontFamily:"verdana"}}>❝ Arun Singh, PSM Candidate❞</div>
    ...
    >
          {ddata.allWpPost.nodes.map((tl) => (
            ...
            <Tab eventKey="tab1" title={  <div
                          className="tab-courses-font" style={{fontSize:"18px",fontWeight:"600", color: "#000" }}
                          dangerouslySetInnerHTML={{
                            __html: tl.acfcoursePage.choachingtab1.heading,
                          }}
...
<div class="wCard-quote__heading mb-3" style={{fontFamily:"verdana"}}>❝ Prashoba, Danfoss ❞</div>
    ...
    >
          {ddata.allWpPost.nodes.map((pl) => (
            ...
            pl.acfcoursePage.options.customUrl == "professional-scrum-product-owner-ii" && pl.acfcoursePage.choachingtab1.heading != "" ?
            <Tab eventKey="tab1" title={  <div
                          className="tab-courses-font"  style={{fontSize:"18px",fontWeight:"600", color: "#000" }}
                          dangerouslySetInnerHTML={{
...
<div class="wCard-quote__heading mb-3" style={{fontFamily:"verdana"}}>❝ Prashoba, Danfoss ❞</div>
      ...
      {ddata.allWpPost.nodes.map((pl) => (
        ...
        pl.acfcoursePage.options.customUrl == "professional-scrum-product-owner-ii" && pl.acfcoursePage.choachingtab2.heading != "" ?
