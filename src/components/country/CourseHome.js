...
export default function CoursePage(props) {
  ...
  return (
    ...
    <h1 style={{fontFamily:"verdana !important", fontWeight:600, textAlign:"center", color:"#182340", marginTop:"2%", fontFamily:"verdana"}}>Agile Careers Pathway</h1>
    ...
    >
          {ddata.allWpPost.nodes.map((tl) => (
            ...
            <Tab eventKey="tab1" title={  <div
                          className="tab-courses-font headnewstyle" style={{fontSize:"14px",fontWeight:"800", color: "#000" }}
