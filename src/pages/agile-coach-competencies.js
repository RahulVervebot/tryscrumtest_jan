            ...
            <div className="two-row">
              <div className="two-row-contain two-row-contain-blue lead">
                ...
                <ol style={{ color: "#012237", fontWeight: "normal" }}>
                  <li><a href="/promote-self-management" target="_blank" className="text-dark text-decoration-underline">Promote Self-Management</a></li>
                  <li><a href="/maintaining-authentic-distance" target="_blank" className="text-dark text-decoration-underline">Maintain Authentic Distance</a></li>

                  <li><a>Facilitate Collaboration</a></li>
                  <li><a>Cultivate Systemic Awareness</a></li>
                  <li><a>Exhibit Ethical Behaviors</a></li>
                  <li><a href="/promote-software-craftsmanship" target="_blank" className="text-dark text-decoration-underline">Promote Software Craftsmanship</a></li>
                </ol>
                <Link to="/team-coaching-capabilities">
              ...
              <div className="two-row-contain two-row-contain-green lead">
                ...
                <Link to="/business-coaching-capabilities">
              ...
              <div className="two-row-contain two-row-contain-red lead">
                ...
                <ol style={{ color: "#012237", fontWeight: "normal" }}>
                <li><a href="/establishing-commitment/" target="_blank" className="text-dark text-decoration-underline">Establishing Commitments</a></li>
                ...
                <Link to="/leadership-coaching-capabilities">
