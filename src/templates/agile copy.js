        ...
        <section className="course-details" style={{fontFamily:"verdana"}}>
          <div className="container-fluid" style={{fontFamily:"verdana"}}>
            <div className="row">
              ...
              {course.acfcoursePage.testimonials.testimonials1 === "" ? (
                ""
                ) : (
...
<h2
      ...
      <Carousel>
      {Object.keys(course.acfcoursePage.testimonials).filter((key) => course.acfcoursePage.testimonials[key]).map((key) => (
   ...
   <div key={key} dangerouslySetInnerHTML={{ __html: course.acfcoursePage.testimonials[key] }} />
   </div>
   </div>
   </div>
</Carousel.Item>
