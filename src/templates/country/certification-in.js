...
import CoursePages from "../../components/country/CoursePage"
import CourseMobile from "../../components/country/CoursepageMobile"
const BlogIndex = ({ data }) => {
  ...
  const myTitle =
    "tryScrum's Agile & Scrum Certifications: Expert-Led Training"
  const myDesc =
    "tryScrum offers comprehensive Agile & Scrum certifications and training programs. Enhance your skills with expert-led courses. ✔Online ✔In-person ✔24x7 Support."
    // useEffect(() => {
