...
//                     const semiTitle = post.course_categories.coursesIncludes.courseDetails.semiTitle;

//                     {/* console.log("location-->", location.pathname, post.course_categories.coursesIncludes.courseDetails.url, post.course_categories.coursesIncludes.courseDetails.semiTitle, index, semiTitle); */}

//                     // console.log("vgccc", .length);

//                     return (

//                       (location.pathname === "/" + url + "/" + subTitle + "/" + semiTitle + "/") && (
